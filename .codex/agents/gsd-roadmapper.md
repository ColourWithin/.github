...
Reference full template: `/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/state.md`.
