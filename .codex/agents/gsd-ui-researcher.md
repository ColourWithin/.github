...
Use template from `/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/UI-SPEC.md`
