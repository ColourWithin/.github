...
<reference>
@/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/user-profiling.md` to load:
