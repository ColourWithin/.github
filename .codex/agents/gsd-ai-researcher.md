...
<required_reading>
Read `/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
