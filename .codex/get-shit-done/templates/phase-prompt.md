...
<!-- For checkpoint task examples and patterns, see @/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/checkpoints.md -->
...
See `/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
