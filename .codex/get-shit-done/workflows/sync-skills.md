...
INSTALL_JS_GLOBAL="/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
