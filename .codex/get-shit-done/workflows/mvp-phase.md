...
<required_reading>
@/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/user-story-template.md
@/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/spidr-splitting.md
@/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/spidr-splitting.md`. Briefly:
