...
See /Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/discovery.md
...
Use /Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/discovery.md.
