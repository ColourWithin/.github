...
Key references:
- @/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @/Volumes/External/ColourWithin/dot-github/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/USER-PROFILE.md" "/Volumes/External/ColourWithin/dot-github/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Volumes/External/ColourWithin/dot-github/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at /Volumes/External/ColourWithin/dot-github/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Volumes/External/ColourWithin/dot-github/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="/Volumes/External/ColourWithin/dot-github/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    /Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   /Volumes/External/ColourWithin/dot-github/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /Volumes/External/ColourWithin/dot-github/.codex/AGENTS.md
```
