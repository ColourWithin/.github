...
```
Agent(
  prompt="Read /Volumes/External/ColourWithin/dot-github/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/SECURITY.md`
