...
<template>
@/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/workflows/transition.md`.
...
- Follow @/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/workflows/diagnose-issues.md
