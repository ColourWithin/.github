...
- **Global scope**: `/Volumes/External/ColourWithin/dot-github/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Volumes/External/ColourWithin/dot-github/.codex/notes/`)
...
2. Glob `/Volumes/External/ColourWithin/dot-github/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Volumes/External/ColourWithin/dot-github/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Volumes/External/ColourWithin/dot-github/.codex/notes/` — works in any directory
