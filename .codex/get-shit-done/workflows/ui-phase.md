...
```markdown
Read /Volumes/External/ColourWithin/dot-github/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: /Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Volumes/External/ColourWithin/dot-github/.codex/agents/gsd-ui-checker.md for instructions.
