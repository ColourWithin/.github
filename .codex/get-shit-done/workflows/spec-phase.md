...
```bash
INIT=$(node "/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/templates/spec.md.
