...
```bash
INIT=$(node "/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Volumes/External/ColourWithin/dot-github/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
